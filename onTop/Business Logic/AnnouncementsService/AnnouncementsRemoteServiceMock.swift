...
class AnnouncementsRemoteServiceMock: AnnouncementsRemoteService {
    ...
    func getAnnouncements(for organisation: Organisation, completion: @escaping GetAnnouncementsForOrganisationCompletion) {
        let matchedAnnouncements = announcements.filter { $0.organisationName == organisation.name}
